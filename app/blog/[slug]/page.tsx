...
export function generateMetadata({ params }: Params): Metadata {
  ...
  return { title: post.title, description: desc, openGraph: { title: post.title, description: desc } };
}
  ...
  return (
    <section className="section">
      <div className="container">
        ...
        <div className="text-xs opacity-70">{new Date(post.date).toLocaleDateString("uk-UA")}</div>
